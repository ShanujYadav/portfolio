            ...
            <div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-4xl m-5 ">
                <div class="p-6 md:p-8 bg-gray-50 rounded-lg shadow-md hover:bg-gradient-to-r from-blue-100 to-indigo-200">
                    ...
                    <ul class="list-disc pl-5 text-gray-700 space-y-2 font-serif">
                        <li>Designed and developed scalable, secure web applications using Node.js, React, Redux.js, and JavaScript, enhancing performance and user experience.</li>
                        <li>Collaborated with cross-functional teams to gather requirements and translate them into efficient technical solutions.</li>
